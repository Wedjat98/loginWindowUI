...
"}")
        ...
        self.label_3.setGeometry(QRect(520, 80, 191, 81))
        font = QFont()
        font.setFamily(u"\u5e7c\u5706")
...
"}")
        ...
        self.checkBox.setGeometry(QRect(440, 310, 91, 19))
...
"}")
        ...
        icon2 = QIcon()
        icon2.addFile(u":/icon/icons/\u5fae\u4fe1.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon3 = QIcon()
        icon3.addFile(u":/icon/icons/QQ.png", QSize(), QIcon.Normal, QIcon.Off)
